...
public class jj extends AppCompatActivity {
   ...
   @Override
    protected void onCreate(Bundle savedInstanceState) {
       ...
       myAdapter transAdapter = new myAdapter(transData,R.layout.tralist);
       ...
       myAdapter cubeeAdapter = new myAdapter(cubeeData,R.layout.cublist);
